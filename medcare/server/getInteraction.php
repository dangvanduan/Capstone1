<?php 
	...
	$sqlComment= "select qa.create_date, qa_content, user_name, dental_address, email,role from user,qa where parent_id= '$qa_id' and qa.user_id= user.user_id"; 
	class comment
	{
