...
{
    header('http://localhost/medcare/index.php'); // Di chuyển đến trang chủ
}
...
{
    echo $show_alert.'Mật khẩu phải có ít nhất 8 ký tự, có ký tự hoa và số.';
}
...
else
{
    ...
    $sql_change_pass = "UPDATE user SET password = '$new_pass' WHERE 'email' = $email";
    // Thực hiện truy vấn
