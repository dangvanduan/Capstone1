...
<head>
    ...
    <title>Xóa câu hỏi ChatBot</title>
...
include('connsql.php');
    ...
    if (isset($_POST['tai_len'])) {
      if($_SERVER["REQUEST_METHOD"]=="POST"){
       ...
       $sql_del = "DELETE From chatbot WHERE id='$id'";
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="post">
                                <div class="form-group">
                                    <select name="cau_hoi" class="col-sm-12 mb-3 mb-sm-0"
                                        style="border-radius: 80px !important;color: #9E9E9E !important;font-size: .8rem;"
                                        selected="selected">
                                        <option>--Chọn--</option>

                                        <?php 
                             $a= "SELECT * FROM chatbot ORDER BY id ASC";
                            $query_a = mysqli_query($conn,$a);
                               while ($row = mysqli_fetch_array($query_a)) {?>
                                ...
                                <input type="submit" name="tai_len" value="Xóa"
